...
<div class="row ">
              ...
              <div class="modal-body" style="padding: 5px;">
                ...
                <div class="row">
                  ...
                  <label for="">Confirmar Password</label>
                    <input class="form-control" name="confirm_password" id="confirm_password" placeholder="Confirmar Password" type="password"  />
                  </div>
                </div>
  ...
  <div class="col-md-7 col-md-offset-3 modal fade" id="modal_edit" tabindex="-1" role="dialog" aria-labelledby="contactLabel" aria-hidden="true">
    <div class="modal-global ">
      <div class="panel panel-primary centrar_modal">
        <div class="block-header bg-primary-dark">
          <button id="d" type="button" class="close" data-dismiss="modal" >x</button>
